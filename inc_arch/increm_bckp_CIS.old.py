...
backup_folder = r"C:\Users\m.houska\OneDrive\ZZ-Archive\CIS_increm"
...
#     ]
# backup_folder = r"C:\Users\m.houska\OneDrive\ZZ-Archive\OneDrive"



ignored_filenames = ["Thumbs.db"]
ignored_extension = ["tmp", "xsd", "xml", "docx", "bee"]
delta_days = 5


#rootFold = r"C:\Users\Miroslav\Documents"
#rootFold = r"C:\temp"
# r"C:\Users\m.houska\OneDrive\Documents",
# r"C:\Users\m.houska\OneDrive\Pictures"
...
for rootFold in rootFolders:
    for folderName, subfolders, filenames in os.walk(rootFold):
        ...
        for filename in filenames:
            ...
            # This is however the way a leading periods should be treated.
